      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        {!about ? (
          ...
          <>
            ...
            {about.subtitle && (
              <p className="text-xl text-gray-600 mb-8 anim-fade-in-up anim-delay-2">{about.subtitle}</p>
            )}

            {about.image && (
              <Reveal className="img-reveal mb-10 overflow-hidden rounded-lg" delay={120}>
                <img
